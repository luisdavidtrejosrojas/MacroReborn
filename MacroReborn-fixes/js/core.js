...
/**
 * Convierte una fecha/timestamp (ISO de Neon, epoch, etc.) en una
 * fecha corta legible tipo "05/08/2026" (mismo formato que ya tenía
 * el placeholder estático de perfil.html). Si no se puede interpretar,
 * devuelve "porDefecto" (o "Desconocida" si no se pasa nada).
 */
